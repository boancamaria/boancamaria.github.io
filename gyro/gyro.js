...
function on_acc_data_uab(e)
{
	...
	document.getElementById("id_acc_x").innerHTML =  Math.round(acc.x * 
100)/100;
	document.getElementById("id_acc_x").innerHTML =  Math.round(acc.y * 
100)/100;
	document.getElementById("id_acc_x").innerHTML =  Math.round(acc.z * 
100)/100;
